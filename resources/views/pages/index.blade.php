...
<div class="container row-fluid clearfix">
    ...
    <div class="clearfix__short">
      ...
      <ul class="short__title-list">
        <li>Professionally managed Investment Casting foundry</li>
        <li>Flexibility for quantities - large / medium / small series - all can be produced.</li>
        <li>Well qualified &amp; experienced skilled staff.</li>
        <li>Consistent Quality.</li>
        <li>Shorter lead time for sample development.</li>
        <li>Quick responses to inquiries / RFQs.</li>
        <li>Specific project managers for large requirements.</li>
        <li>Vision to grow with the customers &amp; keep long term business relations.</li>
      </ul>
    </div>
